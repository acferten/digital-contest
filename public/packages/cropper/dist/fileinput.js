    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document">\n' +
                ...
                '      <div class="kv-zoom-actions"><button type="button" class="btn btn-sm btn-kv btn-default btn-outline-secondary btn-cropper" title="Crop image" onclick="cropOneOfMultipleImage()"><i class="glyphicon glyphicon-edit"></i></button>{toggleheader}{fullscreen}{borderless}{close}</div>\n' +
                '    </div>\n' +
        ...
        _initPreviewActions: function () {
            ...
            $preview.find(btnRemove).each(function () {
                ...
                fnSuccess = function (data, textStatus, jqXHR) {
                    ...
                    const deleted_index = $frame[0].querySelector('.kv-file-remove').getAttribute('data-key');
                    let content = self.getPreview().content;
                    if (typeof content === 'string' || content instanceof String){
                        content = [];
                    } else {
                        content.splice(deleted_index, 1);
                    }
